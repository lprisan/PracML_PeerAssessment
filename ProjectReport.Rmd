...
```{r, cache=T}
# boosted logistic regression (ada)
set.seed(7)
...
```{r}
results <- resamples(list(NB=nbFit, LDA=ldaFit, TREE=treeFit, BAG=bagFit, RF=rfFit, KNN=knnFit, GBM=gbmFit, GAM=gamFit, ADA=adaFit, ANN=nnFit, SVM=svmFit)) #Do for all the models tried out
